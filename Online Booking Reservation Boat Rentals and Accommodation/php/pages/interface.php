...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-center">
            <img src="../img/timbook-carles-tourism.png" alt="Carles Logo" class="nav-logo">
        </div>
        ...
        <div class="nav-right">
            ...
            <div class="nav-buttons">
                ...
                <button class="btn-login" onclick="window.location.href='Loginup_admin.php';">Login</button>
