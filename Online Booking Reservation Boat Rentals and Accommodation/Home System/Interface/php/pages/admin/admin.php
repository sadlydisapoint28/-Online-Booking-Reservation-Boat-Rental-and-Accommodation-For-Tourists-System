...
$stmt = $pdo->query("
    SELECT b.*, u.full_name as user_name, bt.boat_name 
    FROM bookings b 
        ...
        <div class="hidden lg:flex lg:flex-shrink-0">
            <div class="flex flex-col w-64 bg-gray-800">
                <div class="flex items-center justify-center h-16 px-4 bg-gray-900">
                    <h2 class="text-lg font-medium text-white">Admin Dashboard</h2>
                </div>
                <div class="flex flex-col flex-1 overflow-y-auto">
                    <nav class="flex-1 px-2 py-4 space-y-1">
                        <a href="#" class="flex items-center px-2 py-2 text-sm font-medium text-white rounded-md bg-gray-900">
                            <i class="fas fa-tachometer-alt mr-3"></i>
                            Dashboard
                        </a>
                        <a href="#" class="flex items-center px-2 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">
                        ...
                        <a href="../logout.php" class="flex items-center px-2 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">
            ...
            <div class="ml-64 p-8">
                ...
                <?php foreach ($bookings as $booking): ?>
                                <tr class="border-b border-gray-100">
                                    ...
                                    <td class="py-4"><?php echo date('M d, Y', strtotime($booking['check_in_date'])); ?></td>
                                    <td class="py-4">
