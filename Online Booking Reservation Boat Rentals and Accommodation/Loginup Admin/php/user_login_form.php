...
?>
<form id="user-login-form" class="space-y-5 animate-fade-in" method="POST">
    ...
    <div class="form-group transform transition-all duration-300 hover:scale-[1.02]">
        ...
        <div class="relative">
            ...
            <input type="password" id="user-password" name="password" placeholder="••••••••" 
                   ...
                   required />
            <button type="button" id="toggle-user-password" 
    ...
    <div class="mt-4 text-center">
        <p class="text-gray-600">
            ...
            <button type="button" id="switch-to-signup" class="text-blue-600 hover:text-blue-800 font-medium underline transition-colors duration-200">
                Sign up here
            </button>
        </p>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const togglePassword = document.getElementById('toggle-user-password');
        ...
        .then(html => {
            if (html.includes('Invalid email or password')) {
                ...
                Swal.fire({
                    ...
                    window.location.href = '../UserDashboard/index.php';
                });
            }
        })
        .catch(error => {
